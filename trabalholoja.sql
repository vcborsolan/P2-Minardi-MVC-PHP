...
--
-- Host: localhost
-- Generation Time: 06-Dez-2018 às 00:48
...
INSERT INTO `admin` (`userid`, `senha`) VALUES
('adm', '5994471abb01112afcc18159f6cc74b4f511b99806da59b3caf5a9c173cacfc5');
...
INSERT INTO `cliente` (`cpf`, `nome`, `email`, `telefone`, `rua`, `bairro`, `num`, `cep`, `estado`, `cidade`) VALUES
('43645821821', 'victor', 'vorsolan@hotmail.com', '11993478369', 'Marilis', 'jd cavalla', NULL, '175261000', NULL, NULL);
...
INSERT INTO `produto` (`codigo`, `descricao`, `valor`, `idcategoria`) VALUES
(1, 'ESCADA RETRATIL ACME', '55.80', NULL),
(2, 'BALAO DE HELIO ACME', '41.99', NULL),
(3, 'SEMENTE PARA PASSAROS ACME 500g', '8.00', NULL),
(4, 'teste', '10.00', NULL),
(5, 'hhh', '10.00', NULL);
...
ALTER TABLE `cidade`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IX_Relationship2` (`estado`);
...
ALTER TABLE `cliente`
  ADD PRIMARY KEY (`cpf`),
  ADD KEY `IX_Relationship3` (`estado`),
  ADD KEY `IX_Relationship4` (`cidade`);
...
ALTER TABLE `produto`
  ...
  ADD KEY `IX_Relationship1` (`idcategoria`);
...
ALTER TABLE `venda`
  ...
  ADD KEY `fk_venda_cli` (`cliente`);

--
-- Indexes for table `venda_produto`
--
ALTER TABLE `venda_produto`
  ADD PRIMARY KEY (`venda`,`produto`),
  ADD KEY `fk_vp_pro` (`produto`);
...
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `Relationship2` FOREIGN KEY (`estado`) REFERENCES `estado` (`id`);

--
-- Limitadores para a tabela `cliente`
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `Relationship3` FOREIGN KEY (`estado`) REFERENCES `estado` (`id`),
  ADD CONSTRAINT `Relationship4` FOREIGN KEY (`cidade`) REFERENCES `cidade` (`id`);

--
-- Limitadores para a tabela `produto`
--
ALTER TABLE `produto`
  ADD CONSTRAINT `Relationship1` FOREIGN KEY (`idcategoria`) REFERENCES `categoria` (`id`);
